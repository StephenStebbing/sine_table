...
if __name__ == '__main__':
    ...
    argp.add_argument('-v','--verbose',  action='store_true',  help="Include comments in the table. Default false", default=False)

    group = argp.add_mutually_exclusive_group()
    group.add_argument('-po','--phase_offset', default=0, help="phase offset of first entry expressed in table positions. Default 0", type=int)
    group.add_argument('-pod','--phase_offset_degrees', default=0, help="phase offset of first entry expressed in degrees. Default 0", type=float)

    argp.add_argument('-ct','--ctype', type=str,  help="C type for the array elements. Default 'uint8_t'", default ="uint8_t")
    argp.add_argument('-tn','--table_name', type=str,  help="Name for the table variable. Default 'sine_table'", default ="sine_table")
    argp.add_argument('-af','--avr_flash', action='store_true', help="For AVR processors: place table in flash memory", default =False)
    argp.add_argument('-hg','--h_guard', action='store_true', help="For C header file, enclose with #ifndef guard code", default =False)
    argp.add_argument('-hn','--h_guard_name', type=str,  help="Use this name for C header #ifndef guard code. Default 'SINE_TABLE'", default ="SINE_TABLE")
